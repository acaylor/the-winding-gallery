...
All bundled assets are **CC0 1.0** (public domain) — no attribution required,
...
lantern was optimized with [glTF-Transform](https://gltf-transform.dev)
(512 px WebP textures, 9.6 MB → 271 KB).
